...
<form action="placed.php" name="register_form"  id="register_form"  method="post">
	...
	<caption></caption>
	<tr>
		<th colspan="2">  Placed Students Details</th>
		<br>
	</tr>
	<tr>
	...
	<tr>
		<td class="col"  >Reg Number:</td>
		<td><input type="text" class="required" name="p7" value="" /></td>
	</tr>
	<tr>
		<td class="col">Student Name:</td>
		<td><input type="text" name="p8" value="" class="required"  /></td>
	</tr>
	<tr>
		<td class="col">Department:</td>
		<td><input type="text" name="p9" value="" class="required" /></td>
	</tr>
	<tr>
		<td class="col"  >Annual Salary:</td>
		<td><input type="text" class="required" name="p10" value="" /></td>
	</tr>
